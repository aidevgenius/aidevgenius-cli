...
# Paths
AIDEVGENIUS_HOME="${HOME}/.aidevgenius"
FLUTTER_HOME="${AIDEVGENIUS_HOME}/sdk/flutter"
CONFIG_FILE=".aidevgenius.yaml"
...
is_flutter_installed() {
    # Check in aidevgenius managed location
...
read_config() {
    local key="$1"
    local file="${2:-.aidevgenius-flutter.yaml}"
...
has_workflow_file() {
    [[ -f ".github/workflows/aidevgenius-build.yml" ]]
}
